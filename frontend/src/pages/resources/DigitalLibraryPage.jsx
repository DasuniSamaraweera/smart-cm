  ...
  return (
    <div className="space-y-6 pb-2">
      <div className="rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-500/10 via-violet-500/10 to-cyan-500/10 p-5 shadow-sm">
        ...
        <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-900">Digital Library Resources</h1>
        <p className="mt-1 text-sm text-slate-600">Browse and book available study materials.</p>
      </div>
      ...
      {isLoading ? (
        <Card className="rounded-2xl border-slate-200 shadow-sm">
          <CardContent className="p-6 text-sm text-slate-600">Loading digital library resources...</CardContent>
        </Card>
      ) : resources.length === 0 ? (
        <Card className="rounded-2xl border-slate-200 shadow-sm">
          <CardContent className="p-6 text-sm text-slate-600">No digital library resources found.</CardContent>
        </Card>
      ) : (
