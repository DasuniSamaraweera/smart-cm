    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[560px] rounded-2xl border-indigo-100 bg-gradient-to-b from-indigo-50/60 to-white">
        <DialogHeader>
          ...
          <DialogTitle className="text-slate-900 dark:text-slate-100">{isEditing ? 'Edit Resource' : 'Add New Resource'}</DialogTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4 rounded-xl border border-indigo-100 bg-white dark:bg-gray-900 p-4 shadow-sm">
            <div className="col-span-2">
              <Label htmlFor="name" className="text-xs font-medium uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Resource Name</Label>
              <Input
                id="name"
                value={form.name}
            ...
            <div>
              <Label className="text-xs font-medium uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Type</Label>
            ...
            <div>
              <Label htmlFor="capacity" className="text-xs font-medium uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Capacity</Label>
              <Input
                id="capacity"
                type="number"
                min="1"
            ...
            <div className="col-span-2">
              <Label htmlFor="description" className="text-xs font-medium uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Description</Label>
              <Textarea
                id="description"
            ...
            <div className="col-span-2">
              <Label htmlFor="availabilityDate" className="text-xs font-medium uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Availability Date</Label>
              <Input
                id="availabilityDate"
                type="date"
            ...
            <div>
              <Label htmlFor="availabilityStart" className="text-xs font-medium uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Available From</Label>
              <Input
            ...
            <div>
              <Label htmlFor="availabilityEnd" className="text-xs font-medium uppercase tracking-[0.1em] text-slate-500 dark:text-slate-400">Available Until</Label>
              <Input
                id="availabilityEnd"
                type="time"
          ...
          <DialogFooter>
            <Button type="button" variant="outline" className="rounded-xl border-slate-300 dark:border-slate-600" onClick={() => onOpenChange(false)}>
              Cancel
            </Button>
